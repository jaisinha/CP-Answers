...
// Yaad Rakhna
void fun(vector<int> &v, int v1[], int idx, int n, vector<int> &v2)
{
    if (idx == n)
    {
        int sum = 0;
    ...
    v.pb(v1[idx]);
    fun(v, v1, idx + 1, n,v2) ;// insert kiya aur idx badha aake badho 0-1 kaise gaaya vo recursion pe chodh do
        v.ppb();
    fun(v, v1, idx + 1, n,v2) ;// delete kiya aur idx badha aake badho(ayesa lagega ki kuch insert hi nahi kiya)
}
int main()
{
    int v1[] = {1, 2, 1};
