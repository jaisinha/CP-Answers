...
// // Yaad Rakhna
// void fun(vector<int> &v, int v1[], int idx, int n, int sum)
// {
//     if (idx == n)
//     {
//         for (auto &i : v)
//             cout << i << " ";
//         line        // used in the fun()==tru
//             return; // backtrack
//     }
//     sum += v1[idx];
//     v.pb(v1[idx]);
//     fun(v, v1, idx + 1, n, sum); // insert kiya aur idx badha aake badho
//     v.ppb();
//     sum -= v1[idx];
//     fun(v, v1, idx + 1, n, sum); // delete kiya aur idx badha aake badho(ayesa lagega ki kuch insert hi nahi kiya)
// }
// int main()
// {
//     int v1[] = {3, 5, 6, 7};
